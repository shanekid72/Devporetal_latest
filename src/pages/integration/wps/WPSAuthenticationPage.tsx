...
interface WPSAuthenticationPageProps {
  theme?: Theme;
}

const WPSAuthenticationPage: React.FC<WPSAuthenticationPageProps> = ({ theme = { mode: 'light' } }) => {
  const endpoint = wpsApiEndpoints.find(e => e.id === 'wps-authorization');
    ...
    <div className="max-w-5xl mx-auto px-6 py-8">
      <ScrollRevealContainer>
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
            The WPS (Wage Protection System) API uses token-based authentication. All API requests must be made over HTTPS and include a valid access token.
          </p>
        </div>
      </ScrollRevealContainer>
      ...
      <ScrollRevealContainer>
        <section className="mb-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              The Authorization API is used to get access tokens. Access Tokens are used in token-based authentication 
              to allow an application to access an API. The API will return the access token after a user successfully 
              authenticates and authorizes access. This token can be passed as an authorization for other API calls.
            </p>
            <p>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-6">
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              <li className="flex items-start">
                ...
                <span>Access token expiry time in seconds</span>
              </li>
              <li className="flex items-start">
                <span className="font-mono text-sm bg-white dark:bg-gray-800 px-2 py-1 rounded mr-2">refresh_token</span>
                <span>Refresh token to obtain new access token when current token expires</span>
              </li>
            </ul>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex gap-3 p-4 rounded-lg border border-green-200 dark:border-green-800 bg-green-50/50 dark:bg-green-950/20">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  All WPS API requests must be made over HTTPS for security compliance
                </p>
              </div>
            </div>
      ...
      <ScrollRevealContainer>
        <section className="mb-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            <p>
              After obtaining an access token, include it in the Authorization header of all subsequent WPS API requests 
...
Content-Type: application/json`}
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none mt-6">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              <strong>Example:</strong> When making a request to upload salary information or get file status, include the Bearer token 
              in the Authorization header along with the required Content-Type header.
            </p>
          </div>
        </section>
      </ScrollRevealContainer>
      ...
      <ScrollRevealContainer>
        <section className="mb-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            <p>
              The WPS Authentication API uses standard HTTP response codes to indicate success or failure:
            </p>
          </div>
...
export default WPSAuthenticationPage;
