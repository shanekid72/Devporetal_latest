      ...
      >
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 font-body">
            Learn about Wage Protection System (WPS) integration with Digit9 worldAPI.
          </p>
        </div>
        ...
        <div className="glass-card p-8">
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 font-body max-w-2xl mx-auto">
              We're preparing comprehensive documentation for WPS use cases. This will include detailed 
              guides, integration examples, and best practices for implementing Wage Protection System 
              workflows with Digit9 worldAPI.
            </p>
