...
const GetBillerCustomParamsPage = () => {
  const endpoint = billPaymentsApiSections.masters[0].endpoints.find(e => e.id === 'get-biller-custom-params');
...
export default GetBillerCustomParamsPage;
