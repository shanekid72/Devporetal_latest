...
const EnquireTransactionPage = () => {
  const endpoint = billPaymentsApiSections.transactions[0].endpoints.find(e => e.id === 'enquire-transaction');
...
export default EnquireTransactionPage;
