...
const BillPaymentsTransactionsPage = () => {
  ...
  useEffect(() => {
    const currentSection = billPaymentsApiSections.transactions[0];
      ...
      <ScrollRevealContainer>
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
            Complete bill payment transaction lifecycle including quote generation, transaction creation, confirmation, and enquiry.
          </p>
        </div>
      </ScrollRevealContainer>
      ...
      <ScrollRevealContainer>
        <div className="mb-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              The Transaction API provides core functionality for creating and managing bill payment transactions,
              including creating quotes, submitting transactions, confirming payments, and checking transaction status.
            </p>
            <p>
...
export default BillPaymentsTransactionsPage;
